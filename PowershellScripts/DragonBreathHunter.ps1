...
foreach ($Proc in $KeyProcs) {
    $Modules = Get-ProcessModule -ProcessId $Proc.Id -ErrorAction SilentlyContinue | Where-Object { $_.ModuleName -like "*.dll" -and $_.FileName -notlike "*Windows*" -and $_.FileName -notlike "*System32*" }
